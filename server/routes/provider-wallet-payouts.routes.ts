      ...
      const [richResult, summary] = await Promise.all([
        pool.query(`
          SELECT
            ...
            COALESCE(pe.provider_gross_earnings_amount_usd, pe.gross_provider_payout_usd) AS "providerGrossEarningsUsd",
            COALESCE(pe.provider_gross_earnings_amount_local, pe.display_amount) AS "providerGrossEarningsLocal",
            ...
            a.provider_gross_earnings_snapshot                    AS "providerGrossEarningsSnapshot",
            a.commission_amount                                   AS "providerCommissionLocal",
            a.provider_net_earnings_snapshot                      AS "providerNetEarningsSnapshot",
            -- service info
    ...
    try {
      ...
      const result = await pool.query(`
        SELECT
          ...
          COALESCE(pe.provider_gross_earnings_amount_local, pe.display_amount,
