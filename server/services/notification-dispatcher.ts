...
export const notify = {
  appointmentBooked: (userId: string, opts: {
    providerName: string;
    date: string;
    time: string;
    service?: string;
    ...
    dispatchNotification({
      ...
      email: {
        ...
        details: [
          ...
          { label: "Provider", value: opts.providerName },
          ...(opts.service ? [{ label: "Service", value: opts.service }] : []),
          ...(opts.formattedAmount ? [{ label: "Amount", value: opts.formattedAmount }] : []),
        ],
      },
  ...
  paymentReceived: (userId: string, opts: { amount: string; currency: string; appointmentId: string; lang?: Lang; formattedAmount: string }) => {
    ...
    return dispatchNotification({
      ...
      email: {
        ...
        details: [
          { label: "Amount", value: _pmtDisplay },
        ],
      },
