...
import { markListening, markReady, markReadinessFailed } from "./lib/readiness";
    ...
    pricingSnapshotMigration
      ...
      .finally(() => {
        ...
        Promise.all([
          ...
          import("./crons/metrics-snapshot"),
        ]).then(([reminder, reconcile, metrics]) => {
          reminder.startReminderCron();
          reconcile.startLedgerReconcileCron();
          metrics.startMetricsSnapshotCron();
          scheduler.start();
        }).catch((e: Error) => {
