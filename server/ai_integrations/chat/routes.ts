  ...
  app.post("/api/conversations/:id/messages", authenticateToken, async (req: AuthRequest, res: Response) => {
    try {
      ...
      const systemPrompt = [
        ...
        "• Booking, rescheduling, or cancelling appointments with physicians, specialists, mental health professionals, rehabilitation therapists, nurses, dentists, and other healthcare providers",
