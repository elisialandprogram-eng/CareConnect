export const QK = {
  ...
  providerSearch: (type: string, q: string, location: string, verifiedOnly: boolean, minRating: number, homeVisit: boolean, online: boolean, priceMin: number, priceMax: number, page: number) =>
    ["/api/providers", type, q, location, verifiedOnly, minRating, homeVisit, online, priceMin, priceMax, page] as const,
