...
const CATEGORY_KEYS: Record<string, string> = {
  ...
  clinical_and_medical_nutrition: "clinical_nutrition",
  rehabilitation: "rehabilitation",
  physical_therapy_rehabilitation: "rehabilitation",
  physical_therapy_and_rehabilitation: "rehabilitation",
  dental: "dental",
...
const SERVICE_KEYS = new Set([
  ...
  "cardiac_nutrition_counseling",
  "athletic_performance_nutrition",
  "test_therapy",
  "family_medicine",
  "internal_medicine",
  "pediatrics",
