...
const APPOINTMENT_STATUS: Record<string, StatusConfig> = {
  ...
  reschedule_requested:  { label: "Reschedule Requested", classes: "bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400 border-violet-200/60 dark:border-violet-700/40" },
  reschedule_proposed:   { label: "New Time Proposed",    classes: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 border-indigo-200/60 dark:border-indigo-700/40" },
...
const PAYMENT_STATUS: Record<string, StatusConfig> = {
  ...
  cash:                { label: "Cash",                 classes: "bg-muted text-muted-foreground dark:bg-muted dark:text-muted-foreground border-border/60" },
  bank_transfer:       { label: "Bank Transfer",        classes: "bg-muted text-muted-foreground dark:bg-muted dark:text-muted-foreground border-border/60" },
};
