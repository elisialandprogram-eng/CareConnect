import { Timer, Video, CreditCard, ShieldCheck } from "lucide-react";
...
export function HowItWorks() {
  ...
  const steps = [
    {
      icon: Timer,
      title: t("how_it_works.step1_title", "Instant Slot Hold Security"),
      description: t("how_it_works.step1_desc", "Checkout countdown protections lock your chosen time slot the moment you begin booking — no double-bookings, ever."),
      step: 1,
    ...
    {
      icon: Video,
      title: t("how_it_works.step2_title", "Encrypted Pre-Flight Telehealth Lobbies"),
      description: t("how_it_works.step2_desc", "Your video session opens in an encrypted waiting room with live mic and camera checks before you connect with your provider."),
      step: 2,
    ...
    {
      icon: CreditCard,
      title: t("how_it_works.step3_title", "Multi-Currency Stripe Digital Wallets"),
      description: t("how_it_works.step3_desc", "Pay in your local currency via Stripe-powered digital wallets supporting instant multi-rail global payments."),
      step: 3,
    ...
    {
      icon: ShieldCheck,
      title: t("how_it_works.step4_title", "Immutable Double-Entry Ledger Audits"),
      description: t("how_it_works.step4_desc", "Every transaction is recorded in a tamper-proof double-entry ledger with full audit trails and privacy safeguards."),
      step: 4,
