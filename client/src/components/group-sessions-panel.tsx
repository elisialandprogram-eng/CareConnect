...
export function GroupSessionsPanel() {
  ...
  // (server/storage/group-sessions.mixin.ts line 446 confirms this).
  // Do NOT convert to USD before saving.
  const validateNativePrice = (v: string): string => {
    const n = Number(v);
  ...
  const create = useMutation({
    mutationFn: async () => {
      const payload = {
        ...
        pricePerUser: validateNativePrice(String(form.pricePerUser)),
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="grid gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="gs-price">{t("group.f_price", "Price per seat")} ({inputSymbol})</Label>
                  <Input id="gs-price" type="number" min={0} step={inputStep} data-testid="input-group-price"
                ...
                <div key={s.id}
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-3 mt-0.5">
                      ...
                      <span>{fmtCurrency(s.pricePerUser)}</span>
                    </div>
                  </div>
