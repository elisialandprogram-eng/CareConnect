...
import { ALL_ADMIN_ROLES } from "@shared/authorization";
      ...
      <Suspense fallback={<PageFallback />}>
        <Switch>
          ...
          <Route path="/admin/home">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminHome /></ProtectedRoute>
          </Route>
          <Route path="/admin">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminDashboard /></ProtectedRoute>
          </Route>
          <Route path="/admin/stale-bookings">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminStaleBookings /></ProtectedRoute>
          </Route>
          <Route path="/admin/users">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminUsers /></ProtectedRoute>
          </Route>
          <Route path="/packages" component={PackagesPage} />
          <Route path="/membership">
            <ProtectedRoute allowedRoles={["patient"]}><MembershipDashboard /></ProtectedRoute>
          </Route>
          ...
          <Route path="/admin/bug-reports">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminBugReports /></ProtectedRoute>
          </Route>
          <Route path="/admin/compliance-queue">
            <ProtectedRoute allowedRoles={ALL_ADMIN_ROLES}><AdminComplianceQueue /></ProtectedRoute>
          </Route>
