...
const CashFeeSettlementsPanel = lazy(() =>
  import("@/components/admin/dashboard/cash-fee-settlements").then(m => ({ default: m.CashFeeSettlementsPanel }))
);
      ...
      <main className="flex-1 container mx-auto px-4 py-8 overflow-x-hidden">
        ...
        <div className="flex gap-6 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            {activeTab === "cash-fee-settlements" && (
              <PanelErrorBoundary>
                <Suspense fallback={<PanelSkeleton />}>
                  <CashFeeSettlementsPanel />
                </Suspense>
              </PanelErrorBoundary>
            )}
            ...
            {activeTab === "currency-rates" && <CurrencyRatesPanel />}
